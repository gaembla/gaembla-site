...
import MainBlockDecor from "../images/main-block__img.jpg"
    ...
    <div className="main-wrapper">
      ...
      <main className="content">
        ...
        <section className="main-block">
          ...
          <div className="wrapper">
            ...
            <div className="main-block__img">
              <img src="images/main-block__img.jpg" alt="" />
              <img
                src="images/main-block__img-decor.png"
        ...
        <section className="info-block">
          <div className="wrapper">
            <img
              src="images/info-block__decor.svg"
        ...
        <section className="main-about">
          <div className="wrapper">
            <img
              src="images/main-about__bg.jpg"
              className="main-about__bg"
              alt=""
            />
            <img
              src="images/main-about__decor.png"

      ...
      <main className="content">
        ...
        <section className="main-block">
          ...
          <div className="wrapper">
            <img
              src="./Gaembla - Главная_files/main-block__decor.svg"
            ...
            <div className="main-block__img">
              <img src="./Gaembla - Главная_files/main-block__img.jpg" alt="" />
              <img
                src="./Gaembla - Главная_files/main-block__img-decor.png"
        ...
        <section className="info-block">
          <div className="wrapper">
            <img
              src="./Gaembla - Главная_files/info-block__decor.svg"
              className="info-block__decor"
              alt=""
            />
        ...
        <section className="main-about">
          <div className="wrapper">
            <img
              src="./Gaembla - Главная_files/main-about__bg.jpg"
              className="main-about__bg"
              alt=""
            />
            <img
              src="./Gaembla - Главная_files/main-about__decor.png"
              className="main-about__decor"
              alt=""
            />
            ...
            <div className="main-team__content">
              <div className="main-team__info">
                <div className="main-team__info-block">
                  ...
                  <a
                    href="http://dev.verstkovo.ru/gaembla/careers.gaembla.com"
                ...
                <div className="main-team__info-interested">
                  <img
                    src="./Gaembla - Главная_files/main-team__info-interested-decor.svg"
              ...
              <div className="main-team__img">
                <img
                  data-src="img/main-team__img.jpg"
                  src="data:image/gif;base64,R0lGODlhAQABAAAAACw="
                  className="js-img"
                  alt=""
                />
                <img
                  data-src="img/main-team__img-decor.png"
                  src="data:image/gif;base64,R0lGODlhAQABAAAAACw="
          ...
          <div className="wrapper">
            <div className="main-contacts__content">
              <div className="main-contacts__info">
                <img
                  src="./Gaembla - Главная_files/main-contacts__info-decor.svg"
        ...
        <div className="wrapper">
          <div className="header-content">
            <div className="header-logo">
              <img src="./Gaembla - Главная_files/header-logo.svg" alt="" />
            </div>
            <nav className="header-nav">
              <ul>
                <li>
                  <a href="http://dev.verstkovo.ru/gaembla/#">Home</a>
                </li>
                <li>
                  <a href="http://dev.verstkovo.ru/gaembla/#">About Us</a>
                </li>
                <li>
                  <a href="http://dev.verstkovo.ru/gaembla/#">Careers</a>
                </li>
                <li>
                  <a href="http://dev.verstkovo.ru/gaembla/#">Blog</a>
                </li>
                <li>
                  <a href="http://dev.verstkovo.ru/gaembla/#">Contacts</a>
                </li>
              </ul>
            </nav>
      ...
      <footer className="footer">
        <div className="wrapper">
          <div className="footer-content">
            ...
            <ul>
              <li>
                <a href="http://dev.verstkovo.ru/gaembla/#">
